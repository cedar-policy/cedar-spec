...
| [`schema-roundtrip`](fuzz/fuzz_targets/schema-roundtrip.rs) | Schema parser | PBT | Test round trip property: pretty-print ∘ parse == id for schemas
| [`json-schema-roundtrip`](fuzz/fuzz_targets/json-schema-roundtrip.rs) | Schema parser | PBT | Test round trip property: print-json ∘ parse-json ∘ pretty-print ∘ parse == id for schemas
